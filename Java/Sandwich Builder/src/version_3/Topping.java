...
public class Topping {
	...
	public Topping() {
		...
		toppingTypes.put("Teriyaki Glaze", new double[] 			{0.60, 1.0, 1.0});
		toppingTypes.put("Tomato Sauce", new double[] 				{0.50, 1.0, 1.0});
		toppingTypes.put("Marinara Sauce", new double[]				{0.85, 1.0, 1.0});
		toppingTypes.put("Parmesan Cheese", new double[] 			{0.80, 1.0, 1.0});
